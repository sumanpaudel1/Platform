...
from .views import vendor_home, product_detail,  product_create, wishlist_view, add_to_wishlist, remove_from_wishlist, add_to_cart, update_cart, remove_from_cart, cart_view
app_name = 'products'
